...
class BinaryTree
{
    private:
        ...
        void makeQueue(TreeNode* nodePtr, DynamicQueue& qPtr)
        {
            if (nodePtr != nullptr)
            {
                makeQueue(nodePtr->_left, qPtr);
                qPtr.enqueue(nodePtr -> _item);
                makeQueue(nodePtr->_right, qPtr);
            }
        }
    ...
    public:
        ...
        void makeQueue(DynamicQueue& qPtr)
        {
            makeQueue(_root, qPtr);
        }
